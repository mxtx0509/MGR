...
def validate(val_loader, model, criterion, fnames=[]):
    ...
    losses = AverageMeter()
    top1 = AverageMeter()
    reader = open('/export/home/zm/test/icme2019/SR_graph/list/PISC_fine_test.txt')
    ...
    for i, (adj_tensor, per_obj_feature,pose_adj,pose_feature,target) in enumerate(val_loader):
        ...
        if args.write_out:
            ...
            if pre == t:
                shutil.copyfile('/export/home/zm/dataset/PISC/image/'+image_name, './visual/'+image_name)
