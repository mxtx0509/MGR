...
class GRM(nn.Module):
    def __init__(self, num_class = 16,
        ...
        # self.fc7 = nn.Linear(2048,num_class)
    ...
    def forward(self, union, b1, b2, b_geometric, full_im, rois, categories):
        ...
        # x = self.fc6(rois_feature)
        # x = torch.mean(x,dim=0)
        # x = x.view(1,-1)
        # x = self.fc7(x)
        
        # print rois_feature.size()   
        ...
        # # first glance scores
        # scores= self.fg(union, b1, b2, b_geometric)
        scores, union_fea,box1_fea,box2_fea= self.fg(union, b1, b2, b_geometric)
        ...
        return scores, union_fea,box1_fea,box2_fea
