...
parser.add_argument('--val_step',default=1, type=int,
                    help='val step')
parser.add_argument('--num_class',default=16, type=int,
                    help='num_class')
...
parser.add_argument('--feature_dir',default='./checkpoints/pose_1128/', type=str, 
                    help='save_dir')
parser.add_argument('--graph_mode',default='per_obj_pose', type=str,
                    help='mode')
parser.add_argument('--num_gpu', default=1, type=int, metavar='PATH',
                    help='path for saving result (default: none)')
parser.add_argument('--print_freq', default=8, type=int, metavar='PATH',
                    help='path for saving result (default: none)')
...
def get_loader(adj_dir, feature_dir,SIZE):
    train_list ='/export/home/zm/test/icme2019/SR_graph/list/PIPA_relation_train_zm.txt'
    test_list = '/export/home/zm/test/icme2019/SR_graph/list/PIPA_relation_test_zm.txt'
...
def main():
    ...
    print (args)
    if args.graph_mode == 'per_obj_pose':
        SIZE = 42
    elif args.graph_mode == 'per_obj':
        SIZE = 8
    elif args.graph_mode == 'pose':
        SIZE = 34
    else:
